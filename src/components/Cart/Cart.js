                ...
                <div className="content">
                  <form className="cart-listing" method="post" noValidate>
                    <div className="cart-list-headings">
                      <div className="cart-product-header">สินค้า</div>
                      <div className="cart-header-group">
                        <div className="cart-empty-header" />
                        <div className="cart-quantity-header">จำนวณ</div>
                        <div className="cart-price-header">ราคา</div>
                      </div>
                    </div>
                    <CartItems />
                    <div className="total-price">
                      ยอดรวมทั้งหมด<span className="hide-content">
                        {' '}
                        สินค้าทั้งหมด
                      </span>{' '}
              ...
              <section className="cart">
                <div className="content">
                  <div className="cart-listing empty">
                    <p>
                      ยังไม่มีสินค้าอยู่ในตระกร้าสินค้า
                    </p>
